            ...
            <Body onSubmit={formik.handleSubmit}>
              <Header>
                <NormalInput
                  ...
                  value={formik.values.en_name || single.name}
                ...
                <NormalInput
                  ...
                  value={formik.values.official_en_name || single.official_name}
                ...
                <NormalInput
                  ...
                  value={formik.values.en_description || single.description}
                ...
                <NormalInput
                  ...
                  value={formik.values.ru_description || single.group_names[0].description}
                ...
                <NormalInput
                  ...
                  value={formik.values.uz_description || single.group_names[1].description}
              ...
              <Main>
                ...
                <NormalInput
                  ...
                  value={formik.values.salary_percent || single.salary_percent}
                ...
                <NormalInput
                  ...
                  value={formik.values.price || single.price}
                ...
                && 'error'}
                  helperText={formik.touched.price_with_discount
                     && formik.errors.price_with_discount
                     && formik.errors.price_with_discount}
                  value={formik.values.price_with_discount || single.price_with_discount}
