...
export default function* adminProfileSaga() {
  yield takeLatest(types.ADMIN_PROFILE_FETCH_DATA, fetchData);
  yield takeLatest(types.ADMIN_PROFILE_UPDATE, updateProfile);
  yield takeLatest(types.ADMIN_PROFILE_UPLOAD_PHOTO, uploadPhoto);
  yield takeLatest(types.ADMIN_PROFILE_DOWNLOAD_PHOTO, downloadPhoto);
  yield takeLatest(types.ADMIN_PROFILE_DELETE_PHOTO, deletePhoto);
}
